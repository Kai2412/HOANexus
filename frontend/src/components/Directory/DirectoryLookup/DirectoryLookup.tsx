...
const DirectoryLookup: React.FC<DirectoryLookupProps> = ({ 
  ...
  return (
    <div>
      ...
      {/* Pagination */}
      {!loading && hasMultiplePages && onPageChange && (
        <div className="mt-6 flex items-center justify-between border-t border-primary pt-4">
          <div className="text-sm text-secondary">
            Showing {startIndex + 1}-{Math.min(endIndex, totalStakeholders)} of {totalStakeholders} stakeholders
          </div>
